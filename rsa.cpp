...
long long rsa_modExp(long long b, long long e, long long m) //b = message[i], e = exp - 257, m = n = p* q
{
...
char *rsa_decrypt(const long long *message, 
                  ...
                  const struct private_key_class *priv, int count)
{
  ...
  long long i = 0;
  for(i=0; i < message_size/count; i++){
